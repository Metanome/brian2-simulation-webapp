...
def index():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Model selection and equation setup
            if neuron_model == 'lif':
                eqs = '''
                dv/dt = (I - v) / (10*ms) : 1
                I : 1
                ...
                # Create AdEx neuron group with correct units
            ...
            # Create neuron group for non-AdEx models
            ...
            run(sim_time * ms)  # Run the simulation
        ...
        # Save membrane potential traces to CSV
